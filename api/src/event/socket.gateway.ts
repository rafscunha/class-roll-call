...
import { WsConnection, WsPublishMessage, WS_RESPONSE_TYPE, WsPublishStudentAssign } from "./ws-connections.interface";
...
export class SocketGateway implements OnGatewayInit, OnGatewayConnection, OnGatewayDisconnect{
    ...
    async handleConnection(client: any, ...args: any[]) {
        ...
        const accessValidate = await this.adminService.verifyIfRollCallIsOpen(rollCallId)
        if(accessValidate){
